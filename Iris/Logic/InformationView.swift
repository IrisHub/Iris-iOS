            ...
            ScrollView {
                if (self.type == .tos) {
                    Text("""
                        ...
                        IN NO EVENT WILL DROP BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO DROP. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.
                        ...
                        -- Entire Agreement --
                        These Terms constitute the entire agreement between you and Drop regarding the use of the Service, superseding any prior agreements between you and Drop relating to your use of the Service.
                        
                        -- Feedback --
                        Please let us know what you think of the Service, these Terms and, in general, Drop. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, Drop, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.
                    ...
                    Text("""
                        ...
                        If you have questions or comments about this policy, you may email us at irissuggestions@gmail.com.
